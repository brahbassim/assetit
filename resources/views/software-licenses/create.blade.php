...
@section('title', __('app.create') . ' ' . __('app.software_licenses'))

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">@lang('app.create') @lang('app.software_licenses')</h1>
</div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('software-licenses.store') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="software_name" class="form-control @error('software_name') is-invalid @enderror" value="{{ old('software_name') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea name="license_key" class="form-control">{{ old('license_key') }}</textarea>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>@lang('app.total_seats')</label>
                        <input type="number" name="total_seats" class="form-control @error('total_seats') is-invalid @enderror" value="{{ old('total_seats') }}" required min="1">
