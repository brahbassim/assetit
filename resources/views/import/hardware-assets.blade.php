...
@section('title', __('app.import') . ' ' . __('app.hardware_assets'))

@section('content')
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">@lang('app.import') @lang('app.hardware_assets')</h1>
...
<div class="row">
    <div class="col-md-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('import.hardware-assets.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="{{ route('import.hardware-assets.template') }}" class="btn btn-outline-secondary">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <ul>
                    <li>asset_tag</li>
                    <li>name</li>
                    <li>category_id (dropdown - select from list)</li>
                    <li>status (dropdown: available, assigned, maintenance, retired)</li>
                </ul>
                <p><strong>@lang('app.optional_columns'):</strong></p>
                <ul>
                    <li>vendor_id (dropdown - select from list)</li>
                    <li>assigned_employee_id (dropdown - select from list)</li>
                    <li>serial_number</li>
                    <li>purchase_date (YYYY-MM-DD)</li>
                    <li>purchase_cost</li>
                    <li>warranty_expiry (YYYY-MM-DD)</li>
                    <li>notes</li>
                </ul>
